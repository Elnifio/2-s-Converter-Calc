...
OCTO = {"Name": "OCT", "Code": r'^0([0-7]*)$', "Base": 8, "Input_Options": ["oct", "octo", "octal", "o", "8", "eight"], "To_Dec": lambda x: -1, "Dec_To": lambda x: "-1"}
...
def main():
    ...
    in_str = input()
    in_str_list = re.match(r'([0-9A-Za-z]+)\sto\s([0-9A-Za-z]+)', in_str)
